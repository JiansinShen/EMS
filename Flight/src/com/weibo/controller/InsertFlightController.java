...
*/
@WebServlet(name = "InsertFlightController",value = {"/manager/safe/InsertFlightController"})
public class InsertFlightController extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Flight flight = new Flight(flight_num,flight_price,flight_total_seats,flight_rest_seats,
                flight_from_city,flight_to_city);
